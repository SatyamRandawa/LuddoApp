	...
	<div className="main-sidebar main-sidebar-sticky side-menu">
				<div className="sidemenu-logo">
					<Link className="main-logo" to="/home">
						...
						<h2 className="mb-0 text-white text-uppercase">Ludo</h2>
					</Link>
				</div>
				<div className="main-sidebar-body">
					<ul className="nav">
						<li className="nav-item" >
						    <NavLink className="nav-link" to="/admin"><span className="shape1"></span><span className="shape2"></span>
							<i className="fad fa-users-cog  sidemenu-icon menu-icon"></i>
							<span className="sidemenu-label">Admin Management</span>
							</NavLink>
							
						</li>

						<li className="nav-item" >
						    <NavLink className="nav-link" to="/game_rooms"><span className="shape1"></span><span className="shape2"></span>
							<i className="fad fa-users-cog  sidemenu-icon menu-icon"></i>
							<span className="sidemenu-label">Rooms Managment</span>
							</NavLink>
