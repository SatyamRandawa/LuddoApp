const {getDishNum } = require('./helper/game_fun_helper');
...
module.exports = {
    ...
    gameLogic: async function (game, playerId, pos, chipsToMove, moveChipsIn) {
        ...
        resetIdleTimeout(game);
                /////////////////////////////////////////////    
             //  game.lastDice = await  game.nextDice;
                ////////////////////////////////////////////////////
        if (game.waitingForMove) {
           ...
           // console.log("game == ",game);
            console.log("players chips == ",game.players[0].chips);

            console.log("game players stats == ",game.players[0].stats);
        ...
        //////////////////////////////////////////
        let ddddww = await dice(game.gameId);
                
        console.log("last calling == ", ddddww);
        game.lastDice = game.nextDice;
     
        game.nextDice = ddddww;
        console.log("nextDice ==========  ", game.nextDice) ;
        console.log("lastDice ==========  ", game.lastDice) ;
   ...
   /////////////////////////////////////////////////////////////       
    ...
    createGame:  function (players, gameSettings) {
       ...
       // game.roomID = room_ID()
        ...
        let PlayerID = game.players;

        console.log('====================================');
        console.log("gameID",gameID);
        console.log("Playes", PlayerID)
        console.log('====================================');
